    ...
    function login(username, password){
      ...
      api.post(urrl, {
        ...
        if(response.status == 200){
          ...
          localStorage.setItem('userFName', response.data.first_name)
          localStorage.setItem('userLName', response.data.last_name)
          console.log( response.data.id,response.data.first_name, response.data.last_name )
        }     
    })
          .catch(() => {
            $q.notify({
